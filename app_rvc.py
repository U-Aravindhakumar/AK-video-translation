import gradio as gr
from ak_translate.logging_setup import (
    logger,
    set_logging_level,
...
import torch
import os
from ak_translate.audio_segments import create_translated_audio
from ak_translate.text_to_speech import (
...
from ak_translate.translate_segments import (
    translate_text,
    TRANSLATION_PROCESS_OPTIONS,
    DOCS_TRANSLATION_PROCESS_OPTIONS
)
from ak_translate.preprocessor import (
    audio_video_preprocessor,
    audio_preprocessor,
)
from ak_translate.postprocessor import (
    OUTPUT_TYPE_OPTIONS,
...
from ak_translate.language_configuration import (
    LANGUAGES,
...
from ak_translate.utils import (
    remove_files,
    download_list,
    upload_model_list,
    download_manager,
...
from ak_translate.mdx_net import (
    UVR_MODELS,
    MDX_DOWNLOAD_LINK,
    mdxnet_models_dir,
)
from ak_translate.speech_segmentation import (
    ASR_MODEL_OPTIONS,
    COMPUTE_TYPE_GPU,
    COMPUTE_TYPE_CPU,
    find_whisper_models,
...
from ak_translate.text_multiformat_processor import (
    BORDER_COLORS,
...
from ak_translate.languages_gui import language_data, news
import copy
import logging
import json
    ...
    def multilingual_media_conversion(
        ...
        if not get_video_from_text_json:
            ...
            if not self.task_in_cache("refine_vocals", [vocal_refinement], {}):
                ...
                if vocal_refinement:
                    try:
                        from ak_translate.mdx_net import process_uvr_task
        ...
        if not self.task_in_cache("acc_and_vc", [
            ...
            if voice_imitation:
                ...
                from ak_translate.text_to_speech import toneconverter
...
title = "<center><strong><font size='7'>Ak_MSD_Translater</font></strong></center>"
...
if __name__ == "__main__":
    ...
    SoniTr = akTranslate(cpu_mode=args.cpu_mode)
